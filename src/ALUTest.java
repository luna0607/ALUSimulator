...
public class ALUTest  {
    ...
    public void integerReprsentation() throws Exception {
        assertTrue(alu.integerRepresentation("4",4).equals("0100"));
        assertTrue(alu.integerRepresentation("-4",4).equals("1100"));
        assertTrue(alu.integerRepresentation("4",8).equals("00000100"));
        assertTrue(alu.integerRepresentation("-4",8).equals("11111100"));
    }
...
//        assertEquals("123.14321",alu.floatTrueValue("01000010111101100100100101010011",8,23));
   //     assertEquals("0.000012342134513215",alu.floatTrueValue("00110111010011110001000100010000",8,23));
    ...
    public void floatAddition() throws Exception {
        ...
        assertEquals("000111111100000000000000000001000",alu.floatAddition("00111111100000000000000000000111","00111111100000000000000000000001",8,23,4));
        assertEquals("000111111100000000000000000000001",alu.floatAddition("00000001100000000000000000000111","00111111100000000000000000000001",8,23,4));
        assertEquals("001000101011111000110010110011010",alu.floatAddition("01000101011110100000010110011010","01000010000110000000000000000000",8,23,4));
        assertEquals("011000101000100011100100011100010",alu.floatAddition("01000001010001110001111010111000","11000101000100101001000000000000",8,23,4));
        assertEquals("001000111111100010001100010011101",alu.floatAddition("01000111111100000101000010000000","01000011110010000001110110010001",8,23,4));

    }

    @Test
    public void floatSubtraction() throws Exception {
//        assertEquals("001000111111100000101000010000000",alu.floatSubtraction("01000011110010000001110110010001","01000111111100010001100010011101",8,23,4));
        assertEquals("001000011101001000010011001100111",alu.floatSubtraction("01000011101001011011001100110011","01000000010001100110011001100110",8,23,4));
    }

    @Test
    public void floatMultiplication() throws Exception {
    //    assertEquals("00111111100000000000000000000110",alu.floatMultiplication("00111111100000000000000000000010","00111111100000000000000000000011",8,23));
        assertEquals("001000000110000000000000000000000",alu.floatMultiplication("01000000010000000000000000000000","01000000000000000000000000000000",8,23));
        assertEquals("001000100110100111100010100011110",alu.floatMultiplication("01000000100101011100001010001111","01000011101101010000000000000000",8,23));

    }

    @Test
    public void floatDivision() throws Exception {
        assertEquals("001000000010000000000000000000000",alu.floatDivision("01000000110000000000000000000000","01000000000000000000000000000000",8,23));
        assertEquals("001000000100101011100001010001110",alu.floatDivision("01000100110100111100010100011110","01000011101101010000000000000000",8,23));
    }
